...
{
	class BulletBase;
	class SMT_200mm_HE_Slow: BulletBase //Indirect fire HE
	{
    ...
    class SMT_200mm_HE: BulletBase //Fast High explosive
	{
		hit = 300;indirectHit = 0;indirectHitRange = 0; 
		cartridge = "FxCartridge_65_caseless"; /// seems like standard 6.5mm round
		visibleFire = 5; /// how big does the shooter seem to be for AI to take notice after he shoots
    ...
    class SMT_200mm_SALH: BulletBase //Laser guided Missile
	{
        laserLock=1;
    ...
    class SMT_200mm_APFSDS: BulletBase //Armour piercing
	{
		hit = 300;indirectHit = 0;indirectHitRange = 0; 
		cartridge = "FxCartridge_65_caseless"; /// seems like standard 6.5mm round
		visibleFire = 5; /// how big does the shooter seem to be for AI to take notice after he shoots
